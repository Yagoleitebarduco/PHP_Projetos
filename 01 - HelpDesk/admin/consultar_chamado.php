...
while (!feof($arquivo)) { // feof (File end of File) = Le Tudo
  $registro = fgets($arquivo); // fgets = Retorna Linha
      ...
      <div class="card-consultar-chamado">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row mt-5">
              <div class="col-6">
                <a href="../admin/home.php"><button class="btn btn-lg btn-warning btn-block"
